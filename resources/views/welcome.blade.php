...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="{{ URL::to('/') }}">HEART BLOG</a>
            ...
            <div class="col-lg-8 col-md-10 mx-auto">
                <ul class="list-inline text-center">
                    <li class="list-inline-item">
                        <a href="https://www.twitter.com/raisul_hridoy">
                <span class="fa-stack fa-lg">
                  ...
                  <i class="fab fa-twitter fa-stack-1x fa-inverse"></i>
                    ...
                    <li class="list-inline-item">
                        <a href="https://www.facebook.com/exheartz">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
                  <i class="fab fa-facebook-f fa-stack-1x fa-inverse"></i>
                    ...
                    <li class="list-inline-item">
                        <a href="https://www.github.com/hridoyraisul">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
                ...
                <p class="copyright text-muted">Copyright &copy; Raisul Hridoy 2019</p>
            </div>
        </div>
    </div>
</footer>
